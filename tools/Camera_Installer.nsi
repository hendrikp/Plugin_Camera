...
Name "Camera Plugin ${VERSION} for CryEngine"

; The file to write
OutFile "Plugin_Camera_${VERSION}.exe"
...
; Sections
Section "Camera" SEC_PLUGIN
    SectionIn RO
        
    SetOutPath "$INSTDIR\Bin32\Plugins\Camera"
    ;File "${FILES_ROOT}\..\..\Bin32\Plugins\Camera\Plugin_Camera.dll"
	File "${FILES_ROOT}\..\..\Bin32\Plugins\Camera\*.dll"

    SetOutPath "$INSTDIR\Bin64\Plugins\Camera"
    ;File "${FILES_ROOT}\..\..\Bin64\Plugins\Camera\Plugin_Camera.dll"
    File "${FILES_ROOT}\..\..\Bin64\Plugins\Camera\*.dll"

	; Standard Code directory also used in git repo
    SetOutPath "$INSTDIR\Code\Plugin_Camera"
...
Section "Interface Headers" SEC_INTERFACE
    SetOutPath "$INSTDIR\Code\Plugin_Camera\inc"
...
; Set Fileinfos
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "Camera Plugin"
VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Copyright (c) 2013, The authors of the Camera Plugin project"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "Camera Plugin for CryEngine"
...
Function "ShowChangelog"
	Exec 'notepad "$INSTDIR\Code\Plugin_Camera\changelog.md"'
FunctionEnd
